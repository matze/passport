...
mod imp {
    ...
    impl gio::subclass::prelude::ApplicationImpl for Application {
        fn activate(&self, app: &Self::Type) {
            ...
            app.set_resource_base_path(Some("/net/bloerg/Passport/"));
            app.setup_css();
...
impl Application {
    ...
    fn setup_css(&self) {
        ...
        provider.load_from_resource("/net/bloerg/Passport/style.css");
    ...
    fn show_about_dialog(&self) {
        let dialog = gtk::AboutDialogBuilder::new()
            ...
            .website("https://github.com/matze/passport/")
